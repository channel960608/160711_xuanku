...
public class NewEvent {
    ...
    NewEvent(String eventName,String description,int year,int month,int day,int hour,int minute){
    ...
    NewEvent(String eventName,int year,int month,int day,int hour,int minute){
        this.eventName=eventName;
